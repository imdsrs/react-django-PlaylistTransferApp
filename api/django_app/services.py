...
class GoogleRawLoginFlowService:
    ...
    def _get_redirect_uri(self):
        domain = "http://localhost:8000"  # settings.BASE_BACKEND_URL
...
def google_raw_login_get_credentials() -> GoogleRawLoginCredentials:
    ...
    client_id = "515720033979-c374rl8jubtear7c8g3jel8gg2965vib.apps.googleusercontent.com"
    # settings.GOOGLE_OAUTH2_CLIENT_SECRET
    client_secret = "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"
    project_id = "playlist-transfer-app"  # settings.GOOGLE_OAUTH2_PROJECT_ID
